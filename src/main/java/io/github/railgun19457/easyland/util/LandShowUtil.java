...
public class LandShowUtil {
    ...
    public static void showLandBoundary(JavaPlugin plugin, Player player, List<int[]> chunkRanges,
            int durationSeconds) {
    ...
    private static Particle getParticleFromConfig(JavaPlugin plugin) {
        ...
        try {
            ...
            plugin.getLogger().warning("Invalid particle type: " + particleName + ", using default: FIREWORK");
